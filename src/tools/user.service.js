...
const getDoctors = () => axios.get(`http://localhost:3001/doctors`, { headers: authHeader() });
const getDoctor = id => axios.get(`http://localhost:3001/doctors/${id}`, { headers: authHeader() });
